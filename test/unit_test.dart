...
void main(){
  ...
  group('Movie model tests: ', (){
    ...
    test('1. Like function should increment likes and undo the changes on calling twice',(){
    ...
    test('2. Dislike function should increment dislikes and undo the changes on calling twice',(){
    ...
    test('3. Calling Like function should automatically undo the changes done by Dislike function',(){
    ...
    test('4. Calling Dislike function should automatically undo the changes done by Like function',(){
